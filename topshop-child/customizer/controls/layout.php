    ...
    public function render_content() {
        ...
        <div style="overflow: hidden; zoom: 1;">
            ...
            <label style="width: 48%; float: left; margin-right: 3.8%; text-align: center;">
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/customizer/controls/img/2cl.png" alt="Left Sidebar" style="display: block; width: 100%;" />
            ...
            <label style="width: 48%; float: right; text-align: center;">
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/customizer/controls/img/2cr.png" alt="Right Sidebar" style="display: block; width: 100%;" />
